...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		<a class="skip-link screen-reader-text" href="#main-content-wrapper">
			<?php _e( 'Skip to content', 'fhomeservices' ); ?>
		</a>
		<div id="body-content-wrapper">
				...
				<div id="header-content-wrapper">
					...
					<div id="header-top">
						<ul class="header-social-widget">
							<?php fhomeservices_show_social_sites(); ?>
						</ul>
					</div>
			...
			<?php if ( is_front_page() && get_option( 'show_on_front' ) == 'page' ) : ?>
					...
					<?php if ( get_theme_mod('fhomeservices_slider_display', 0) == 1 ) : ?>

							<div id="slider-content-wrapper">
								<?php fhomeservices_display_slider(); ?>
